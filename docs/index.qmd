...
#| message: false
#| warning: false
data <- read.csv("/Users/amazingruan/Downloads/GIS/clone/restaurant.csv")
data <- na.omit(data)
...
#| message: false
#| warning: false
restaurant_data <- readxl::read_excel("/Users/amazingruan/Downloads/GIS/clone/filtered.xlsx")
